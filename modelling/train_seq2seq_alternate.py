        ...
        with torch.no_grad():
            ...
            for batch in tqdm(eval_dataloader):
                ...
                input_args = {'input_ids': input_ids,
                              ...
                              'num_beams': args.num_beams, 'length_penalty': 2, 'no_repeat_ngram_size': 3, 'max_length': 100,
...
def main():
    ...
    parser.add_argument("--num_beams", type=int, default=6, help="beam size for generation")
    ...
    #now assume head0/head1 and the gate_prob needs to explicitly added to the output and generate function
    ...
    if args.do_test:
        ...
        test_dataset = train_seq2seq_utils.load_and_cache_examples(args, tokenizer, 'train')
