...
./test_1.sh > ~/summarization/hydra-sum/modelling/tgpu_0.log 2>&1 &
#get pid 
pid_1=$!

echo "starting  gpu 1 in the background"
./test_2.sh > ~/summarization/hydra-sum/modelling/tgpu_1.log 2>&1 &
#get pid
pid_2=$!

echo "starting  starting 2 in the background"
./test_3.sh > ~/summarization/hydra-sum/modelling/tgpu_2.log 2>&1 &
#get pid
pid_3=$!

echo "starting  gpu 3 in the background"
./test_4.sh > ~/summarization/hydra-sum/modelling/tgpu_3.log 2>&1 &
#get pid
pid_4=$!
